...
module.exports = class helpSlashCommand extends BaseSlashCommand {
    ...
    run(client, interaction) {
        let helpMessageEmbed = new EmbedBuilder()
            ...
            .addFields({ name: "/project :bar_chart:", value: "introduce your project", inline: true }, { name: "/code :computer:", value: "coding features", inline: true }, { name: "/team :busts_in_silhouette:", value: "setup a team", inline: true })
            .addFields({ name: "/create :envelope_with_arrow:", value: "create a project", inline: true }, { name: "/system :gear:", value: "system Commands", inline: true }, { name: "/build :hammer:", value: "create a message", inline: true })
            .setTimestamp()
