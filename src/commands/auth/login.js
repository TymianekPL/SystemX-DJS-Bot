...
module.exports = class LoginSlashCommand extends BaseSlashCommand {
     ...
     async run(client, interaction) {
          const LoginUser = await RegisterModel.findOne({
          ...
          let success_login = new EmbedBuilder()
               ...
               .setDescription(
                    "You have been Logged in, " + LoginUser?.username
               )
               .setTimestamp()
               .setColor("Green")
               .setFooter({
          ...
          let notFound_message = new EmbedBuilder()
               ...
               .setDescription(
                    "Invalid Password & Username, Please check you informations!?"
               )
               .setColor("Red")
               .setTimestamp()
               .setFooter({
          ...
          try {
               ...
               if (
                    ...
                    if (LoginUser?.isLogged) {
                         return interaction.reply({
                              embeds: [alreadyLogged_message],
                              ephemeral: true
                         });
                    } else {
                         const changeLogginBoolean =
